...
public abstract class GyroIO implements Sendable {
  ...
  /** Updates the gyro's data This should be called periodically */
  public void update() {
    updateInputs();
  ...
  /**
   * Updates the gyro's data This should be called periodically in this function update the inputs
   */
  ...
  /**
   * gets the angle of the gyro in degrees this angle is continuous and can be greater than 360 or
   * less than 0
   *
  ...
  /**
   * gets the pitch of the gyro in degrees this angle is between -90 and 90
   *
  ...
  /**
   * gets the roll of the gyro in degrees this angle is between -180 and 180
   *
  ...
  /**
   * gets the acceleration of the gyro in the x direction in m/s^2 the value is gyro relative and
   * not field relative be careful with this value, it is not always accurate (depends on the gyro's
   * location)
   *
  ...
  /**
   * gets the acceleration of the gyro in the y direction in m/s^2 the value is gyro relative and
   * not field relative be careful with this value, it is not always accurate (depends on the gyro's
   * location)
   *
