...
public class MarinersMeasurementsCTRE extends MarinersMeasurements {
  ...
  public MarinersMeasurementsCTRE(StatusSignal<Angle> positionSignal, double gearRatio) {
    super(positionSignal::getValueAsDouble, gearRatio);

    signals = new BaseStatusSignal[] {positionSignal};
  }

  public MarinersMeasurementsCTRE(
      StatusSignal<Angle> positionSignal, double gearRatio, double refreshHz) {
    super(positionSignal::getValueAsDouble, gearRatio);
  ...
  public MarinersMeasurementsCTRE(
      ...
      double gearRatio) {
    super(positionSignal::getValueAsDouble, velocitySignal::getValueAsDouble, gearRatio);
