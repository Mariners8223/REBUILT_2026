...
public enum DevBotConstants {
  ...
  public static final TrapezoidProfile.Constraints DRIVE_CONSTRAINTS =
      new TrapezoidProfile.Constraints(18, 100);

  // velocity and acceleration constraints for the steer motor
  public static final TrapezoidProfile.Constraints STEER_CONSTRAINTS =
  ...
  /**
   * the offset between the zero of the magnet of the encoder and the zero of the module (in
   * rotations)
   */
  ...
  /** the kS for the drive motor the voltage needed to overcome static friction units are volts */
  public final double DRIVE_KS;

  /** the kV for the drive motor units are volts per radian per second (V/rad/s) */
  public final double DRIVE_KV;

  /** the kA for the drive motor units are volts per radian per second squared (V/rad/s^2) */
  public final double DRIVE_KA;

  /** the kS for the steer motor the voltage needed to overcome static friction units are volts */
  public final double STEER_KS;

  /** the kV for the steer motor units are volts per radian per second (V/rad/s) */
  public final double STEER_KV;

  /** the kA for the steer motor units are volts per radian per second squared (V/rad/s^2) */
