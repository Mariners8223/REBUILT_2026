...
public class DriveCommand extends Command {
  ...
  public void execute() {
    ...
    // double R2Axis = (1 - (0.5 + controller.getR2Axis() / 2)) * (driveBase.MAX_FREE_WHEEL_SPEED -
    // 1) + 1;
    ...
    // if(Robot.isRedAlliance) gyroAngle = gyroAngle.plus(Rotation2d.fromDegrees(180)); TODO:FIX
    // THIS VERY VERY IMPORTANT!!!!!!!!!!!!!!

    ChassisSpeeds robotRelativeSpeeds =
        ChassisSpeeds.fromFieldRelativeSpeeds(fieldRelativeSpeeds, gyroAngle);
